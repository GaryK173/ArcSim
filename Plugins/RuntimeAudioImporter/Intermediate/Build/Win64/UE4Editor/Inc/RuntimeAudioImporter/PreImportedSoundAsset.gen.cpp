...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPreImportedSoundAsset_Statics::NewProp_AudioDataArray_MetaData[] = {
		{ "Comment", "/** Audio data array. Only MP3 data is intended to be here */" },
		{ "ModuleRelativePath", "Public/PreImportedSoundAsset.h" },
		{ "ToolTip", "Audio data array. Only MP3 data is intended to be here" },
	};
#endif
	...
	IMPLEMENT_CLASS(UPreImportedSoundAsset, 924380438);
